import { createLightNode, Protocols, createEncoder, createDecoder, ReliableChannel } from '@waku/sdk';
...
async function initWaku() {
  ...
  // Add delivery tracking listeners
  ...
  // Update status and enable send button
